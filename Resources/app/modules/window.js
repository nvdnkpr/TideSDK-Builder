 ...
 *  before_close: function()    //The function gets called when the user executed any window-closing action. Close can be canceled by returning false.
 *  css_style: ''               //CSS class to append to the window content area.
 * }
 *
 *
 ...
 *
 */
define(['text!templates/window.html', 'text!templates/window-button.html'], function (base_template, button_template) {
    ...
    return function (params) {
        ...
        params = _.extend(settings, params);
        ...
        obj.content_el.css('max-height', params.height_limit).addClass(params.css_class);
